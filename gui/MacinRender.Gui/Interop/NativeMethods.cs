...
/// <summary>
/// P/Invoke 绑定:每个声明逐一对应 include/adm/c_api.h(stable v1.30)的导出函数。
...
internal static partial class NativeMethods
{
    ...
    [LibraryImport(Lib)]
    internal static partial AdmErrorCode adm_render_options_set_lfe_routing_mode(AdmRenderOptionsHandle opts,
        AdmLfeRoutingMode mode);
    ...
    [LibraryImport(Lib)]
    internal static partial AdmErrorCode adm_layouts_json(AdmContextHandle context, out IntPtr outJson);
