...
public sealed class Localizer : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["CopyAll"] = "Copy all",
        ["AboutMenu"] = "About MacinRender ADM",
        ["AboutTitle"] = "About MacinRender ADM",
        ["AboutProductVersion"] = "Product version",
        ["AboutCApiVersion"] = "C API version",
        ["AboutCommit"] = "Build commit",
        ["AboutProject"] = "Project page",
        ["AboutClose"] = "Close",
