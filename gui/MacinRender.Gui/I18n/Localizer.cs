...
public sealed class Localizer : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> Zh = new()
    {
        ...
        ["SemHeadTrackCol"] = "头追踪",
        ["SemHeadParticipate"] = "场景相对（参与头追踪）",
        ["SemHeadParticipateShort"] = "场景",
        ...
        ["SemLufsHint"] = "LUFS：M=瞬时，S=短时，I=综合",
        ["SemMonToStart"] = "回到开头",
        ["SemMonBackend"] = "监听后端",
        ["SemSystemSpatial"] = "系统空间音频",
        ...
        ["SemGainMuteHint"] = "滑块最左端或输入 -inf = 静音",
        ["SemDiffuseUnsupportedHint"] = "{0} 不支持 diffuse，当前监听中不会生效（编辑仍会写入导出的 ADM）",
        ["SemExtentWidthHint"] = "长按切换 Width 联动 · 双击重置 extent",
        ["SemExtentHeightHint"] = "长按切换 Height 联动 · 双击重置 extent",
        ["SemExtentDepthHint"] = "长按切换 Depth 联动 · 双击重置 extent",
        ["SwitchTheme"] = "切换主题",
        ["OutputSettings"] = "输出设置",
        ["Backend"] = "渲染后端",
        ["Layout"] = "输出布局",
        ["SpeakerGeometry"] = "扬声器几何",
        ["LfeRoutingDirect"] = "独立直通",
        ["LfeRoutingSplitPower"] = "等功率双路 (−3.01 dB)",
        ["LfeRoutingTooltip"] = "22.2 LFE：{0}",
        ["Codec"] = "编码器",
        ["Container"] = "容器",
        ["FileQueue"] = "文件队列",
        ["EventLog"] = "事件 / 日志",
        ...
        ["QueueStatusPending"] = "待渲染",
        ["QueueStatusRendering"] = "渲染中",
        ["QueueStatusDone"] = "完成",
        ...
        ["DetailInput"] = "输入：{0}",
        ["DetailOutput"] = "输出：{0}",
        ["DetailErrorCode"] = "错误代码：{0}",
        ["ErrorCreateContext"] = "无法创建 ADM 上下文",
        ["ErrorCreateRenderOptions"] = "无法创建渲染选项",
        ["ErrorExportFailed"] = "导出失败：{0}",
        ["ErrorRenderNoResult"] = "渲染已完成，但未返回结果句柄",
        ["ErrorRenderFailed"] = "渲染失败：{0}",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["SemHeadParticipate"] = "Scene-relative (head tracked)",
        ["SemHeadParticipateShort"] = "Scene",
        ...
        ["SemLufsHint"] = "LUFS: M=momentary, S=short-term, I=integrated",
        ["SemMonToStart"] = "To start",
        ["SemSystemSpatial"] = "System Spatial Audio",
        ...
        ["SemGainMuteHint"] = "Far-left slider position or -inf input = mute",
        ["SemDiffuseUnsupportedHint"] = "{0} does not support diffuse; it will not affect current monitoring (the edit is still written to exported ADM)",
        ["SemExtentWidthHint"] = "Long-press to toggle Width linking · double-click to reset extent",
        ["SemExtentHeightHint"] = "Long-press to toggle Height linking · double-click to reset extent",
        ["SemExtentDepthHint"] = "Long-press to toggle Depth linking · double-click to reset extent",
        ["SemMonBackend"] = "Monitor backend",
        ["SwitchTheme"] = "Theme",
        ["OutputSettings"] = "Output Settings",
        ["Backend"] = "Renderer",
        ["Layout"] = "Output Layout",
        ["SpeakerGeometry"] = "Speaker Geometry",
        ["LfeRoutingDirect"] = "Independent direct",
        ["LfeRoutingSplitPower"] = "Equal-power dual (−3.01 dB)",
        ["LfeRoutingTooltip"] = "22.2 LFE: {0}",
        ["Codec"] = "Codec",
        ["Container"] = "Container",
        ...
        ["QueueStatusRendering"] = "Rendering",
        ...
        ["NFiles"] = "{0} files",
        ["DetailInput"] = "Input: {0}",
        ["DetailOutput"] = "Output: {0}",
        ["DetailErrorCode"] = "Error code: {0}",
        ["ErrorCreateContext"] = "Failed to create ADM context",
        ["ErrorCreateRenderOptions"] = "Failed to create render options",
        ["ErrorExportFailed"] = "Export failed: {0}",
        ["ErrorRenderNoResult"] = "Render completed without a result handle",
        ["ErrorRenderFailed"] = "Render failed: {0}",
        ["Raw"] = "{0}",
    };
}
