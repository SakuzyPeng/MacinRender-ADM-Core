...
Result<FloatOpusMkaWriter> FloatOpusMkaWriter::open(const std::string& path, uint32_t channels, uint32_t sample_rate) {
    ...
    const int32_t bitrate = (channels <= 2U) ? 128000 : static_cast<int32_t>(channels) * 64000;
