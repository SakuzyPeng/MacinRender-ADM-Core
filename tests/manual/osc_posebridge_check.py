...
def main():
    ...
    assert c.sizeof(Pose) == 80 and c.sizeof(Status) == 64
    assert lib.adm_api_version_major() == 1 and lib.adm_api_version_minor() >= 40
