...
usage() {
    cat <<'EOF'
Usage: scripts/release/smoke-package.sh <dist/mradm-...tar.gz>

Verifies the package checksum, extracts it to a temporary directory, and runs basic CLI smoke checks.
EOF
}
